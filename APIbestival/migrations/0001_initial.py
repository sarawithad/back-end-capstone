# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-06-13 21:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='APIbestival.Date')),
            ],
        ),
        migrations.CreateModel(
            name='FestivalArtist',
        ...
        migrations.AddField(
            model_name='festivalgenre',
            name='festival',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='APIbestival.Festival'),
        ),
        migrations.AddField(
            model_name='festival',
            name='location',
